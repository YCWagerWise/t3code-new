...
/**
 * The transport swap (doc 15 §3.1): both factories provide the same RpcSessionFactory tag.
 * Flag-gated so the Effect-RPC path stays one flip away during the cutover.
 */
